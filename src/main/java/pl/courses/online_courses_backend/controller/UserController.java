...
public class UserController extends BaseController<UserDTO, UserService> {
    ...
    public ResponseEntity<Void> register(@RequestPart(required = false) MultipartFile photo, @Valid @RequestPart UserDTO userDTO) {
        userService.register(photo, userDTO);
